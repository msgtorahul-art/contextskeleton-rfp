...
export default function LandingPage() {
  ...
  const pricingProducts = [
    ...
    { name: 'GovWin SBIR Grant Pro', price: '$999', period: '/ month', tag: 'Product #4', badge: 'Startups & Defense', color: 'indigo', href: '/gov-grant', features: ['Unlimited SAM.gov & SBIR Pre-Audits', 'FAR Jargon Narrative Formatting', 'CSV / Docx Proposal Export'] },
    { name: 'FDA 510(k) MedTech Pro', price: '$999', period: '/ month', tag: 'Product #5', badge: 'MedTech & Biotech', color: 'pink', href: '/fda-510k', features: ['Unlimited 510(k) Predicate Audits', '21 CFR Part 820 Design Controls', 'CSV Predicate Audit Spreadsheet'] },
