...
export function middleware(req: NextRequest) {
  ...
  // Redirect unauthenticated users trying to access protected workspace routes (/projects, /consent, /security-questionnaire, /fda-510k, /knowledge, /dashboard) to /auth
